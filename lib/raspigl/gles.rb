...
module RaspiGL::GLES
  extend FFI::Library
  ffi_lib File.join(RaspiGL::VC_PATH, 'lib', 'libGLESv2.so')
  ...
  attach_function :glFrustumf,          [:float, :float, :float, :float, :float, :float], :void
  attach_function :glGetClipPlanef,     [:uint, :pointer], :void
  ...
  attach_function :glOrthof,            [:float, :float, :float, :float, :float, :float], :void
  ...
  attach_function :glColor4ub,                [:uint8, :uint8, :uint8, :uint8], :void
  attach_function :glColor4x,                 [:int32, :int32, :int32, :int32], :void
  ...
  attach_function :glDepthRangex,             [:int32, :int32], :void
  ...
  attach_function :glGetString,               [:uint], :uint8
  ...
  attach_function :glMultiTexCoord4x,         [:uint, :int32, :int32, :int32, :int32], :void
  attach_function :glNormal3x,                [:int32, :int32, :int32], :void
  attach_function :glNormalPointer,           [:uint, :int, :pointer], :void
  attach_function :glOrthox,                  [:int32, :int32, :int32, :int32, :int32, :int32], :void
  attach_function :glPixelStorei,             [:uint, :int], :void
  attach_function :glPointParameterx,         [:uint, :int32], :void
  attach_function :glPointParameterxv,        [:uint, :pointer], :void
  attach_function :glPointSizex,              [:int32], :void
  attach_function :glPolygonOffsetx,          [:int32, :int32], :void
  ...
  attach_function :glRotatex,                 [:int32, :int32, :int32, :int32], :void
  attach_function :glSampleCoverage,          [:float, :uchar], :void
  attach_function :glSampleCoveragex,         [:int32, :uchar], :void
  attach_function :glScalex,                  [:int32, :int32, :int32], :void
  ...
  attach_function :glTexEnvx,                 [:uint, :uint, :int32], :void
  ...
  attach_function :glTexParameterx,           [:uint, :uint, :int32], :void
  ...
  attach_function :glTranslatex,              [:int32, :int32, :int32], :void
